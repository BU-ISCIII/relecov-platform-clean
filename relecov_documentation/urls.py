...
urlpatterns = [
    ...
    path(
        "relecovInstall/",
        relecov_documentation.views.relecov_install,
        name="relecov_install",
    ),
    path(
        "configuration/",
        relecov_documentation.views.configuration,
        name="configuration",
    ),
    path("metadata/", relecov_documentation.views.metadata, name="metadata"),
    path(
        "metadataLabExcel/",
        relecov_documentation.views.metadata_lab_excel,
        name="metadata_lab_excel",
    ),
    path(
        "relecovTools/", relecov_documentation.views.relecov_tools, name="relecov_tools"
    ),
    path(
        "intranetOverview/",
        relecov_documentation.views.intranet_overview,
    ...
    path(
        "variantDashboard/",
        relecov_documentation.views.variant_dashboard,
    ...
    path(
        "nextstrainInstall/",
        relecov_documentation.views.nextstrain_install,
        name="nextstrain_install",
    ),
    path(
        "howtoNextstrain/",
        relecov_documentation.views.howto_nextstrain,
        name="howto_nextstrain",
    ),
    path(
        "uploadToEna/", relecov_documentation.views.upload_to_ena, name="upload_to_ena"
    ),
    path(
        "uploadToGisaid/",
        relecov_documentation.views.upload_to_gisaid,
